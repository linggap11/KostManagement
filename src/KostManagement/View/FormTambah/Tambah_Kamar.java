 ...
 * @author Afifp29
 */
public class Tambah_Kamar extends javax.swing.JFrame {

    /**
     * Creates new form Tambah_Kamar
     */
    public Tambah_Kamar() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        inp_kdkamar = new javax.swing.JTextField();
        inp_luaskamar = new javax.swing.JTextField();
        btn_simpan = new javax.swing.JLabel();
        inp_hargabulanan = new javax.swing.JTextField();
        ...
        jPanel9.add(jSeparator8, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 40, 130, 10));
        ...
        jPanel9.add(jLabel35, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 10, -1, -1));
        ...
        sidePane.add(inp_kdkamar, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 30, 100, -1));
        sidePane.add(inp_luaskamar, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 70, 240, -1));
        ...
        sidePane.add(btn_simpan, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 200, -1, -1));
        sidePane.add(inp_hargabulanan, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 110, 130, -1));
        ...
        sidePane.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 190, 60, 50));
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(sidePane, javax.swing.GroupLayout.DEFAULT_SIZE, 414, Short.MAX_VALUE)
        );
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addComponent(sidePane, javax.swing.GroupLayout.DEFAULT_SIZE, 287, Short.MAX_VALUE))
        );
...
int xy;
    ...
    private void btn_simpanMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_simpanMouseClicked
        String kodeKamar = inp_kdkamar.getText();
        String luaskamar = inp_luaskamar.getText();
        int harga = Integer.parseInt(inp_hargabulanan.getText());
        KamarController kamar = new KamarController();
        if( kamar.tambahData(kodeKamar, luaskamar, harga, "P1")==1){
              JOptionPane.showMessageDialog(null, "Data Berhasil Disimpan ^_^");
              
        }else
        {      
                JOptionPane.showMessageDialog(null, "Data Gagal Disimpan -_-!");
        }
       ;
        setVisible(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Tambah_Kamar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JTextField inp_hargabulanan;
    private javax.swing.JTextField inp_kdkamar;
    private javax.swing.JTextField inp_luaskamar;
